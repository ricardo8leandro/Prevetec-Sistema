...
$dir_file_manager = DIR_PAGE.'public/ckeditor/file_manager/';
?>
<!DOCTYPE html>
<html>  
<head>  
    ...
    <link rel="stylesheet" type="text/css" href="<?= $dir_file_manager; ?>browse.css">
...
$dir = DIR_PAGE.'public/ckeditor/uploads/';
$dir_src = DIR_REQ .'public/ckeditor/uploads/';
...
tbl.onclick =   
    ...
    <script type="text/javascript" src="<?= $dir_file_manager; ?>remove-image.js"></script>
</body>  
</html> 