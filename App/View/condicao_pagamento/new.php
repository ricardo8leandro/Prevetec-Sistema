<?php 
    ...
    $inputName = "novaCondicaoDePagamento";
    $btn = "Criar";
    $conteudo = "";

    if(isset($this->list['editar']) && is_array($this->list['editar'])){
        $inputName = "editCondicaoDePagamento";
        $status = 0;
        $formId = "formEditar";
        $id = $this->list['editar']['cd_condicao_pagto'];
    ...
    <div class="panel-body">
    	<form method="post" class="form-horizontal" action="" id="<?= $formId; ?>" >
            ...
            <div class="form-group">
                ...
                <div class="col-lg-12">
                    <textarea cols="100" id="conteudo" name="conteudo" rows="100"><?= $conteudo; ?></textarea>
...
<script type="text/javascript">
    var url_cad_edit = "condicao-de-pagamento/";
</script>