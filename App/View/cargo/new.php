<?php 
    ...
    if(isset($this->list['editar']) && is_array($this->list['editar'])){
        ...
        $status = 0;
        $formId = "formEditar";
        $id = $this->list['editar']['cd_cargo'];
        $nome = $this->list['editar']['nm_cargo'];
        $status = $this->list['editar']['ic_cargo'];
        $btn = "Atualizar";
    }
?>
    ...
    <div class="panel-body">
    	<form method="post" class="form-horizontal" action="" id="<?= $formId; ?>">
            <div class="form-group">
                <label class="col-lg-4 control-label" for="nome">Nome do cargo</label>
                <div class="col-lg-5">
